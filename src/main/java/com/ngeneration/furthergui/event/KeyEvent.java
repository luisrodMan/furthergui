...
public class KeyEvent extends Event {
	 ...
	 */
	public static final int KEY_PRESSED = 1; // Event.KEY_PRESS

	/**
	 * The "key released" event. This event is generated when a key is let up.
	 */
	public static final int KEY_RELEASED = 0; // Event.KEY_RELEASE

	public static final int KEY_REPEATED = 2; // Event.KEY_RELEASE
	...
	public static final int VK_BACK_SPACE = GLFW.GLFW_KEY_BACKSPACE;

	/** Constant for the TAB virtual key. */
	public static final int VK_TAB = GLFW.GLFW_KEY_TAB;
	...
	public static final int VK_SHIFT = GLFW.GLFW_KEY_LEFT_SHIFT;

	/** Constant for the CONTROL virtual key. */
	public static final int VK_CONTROL = GLFW.GLFW_KEY_LEFT_CONTROL;

	/** Constant for the ALT virtual key. */
	public static final int VK_ALT = GLFW.GLFW_KEY_LEFT_ALT;
	...
	public static final int VK_ESCAPE = GLFW.GLFW_KEY_ESCAPE;
	...
	public static final int VK_END = GLFW.GLFW_KEY_END;

	/** Constant for the HOME virtual key. */
	public static final int VK_HOME = GLFW.GLFW_KEY_HOME;
	 ...
	 * @see #VK_KP_LEFT
	 */
	public static final int VK_LEFT = GLFW.GLFW_KEY_LEFT;
	 ...
	 * @see #VK_KP_UP
	 */
	public static final int VK_UP = GLFW.GLFW_KEY_UP;
	 ...
	 * @see #VK_KP_RIGHT
	 */
	public static final int VK_RIGHT = GLFW.GLFW_KEY_RIGHT;
	 ...
	 * @see #VK_KP_DOWN
	 */
	public static final int VK_DOWN = GLFW.GLFW_KEY_DOWN;
	...
	public static final int VK_A = GLFW.GLFW_KEY_A;

	/** Constant for the "B" key. */
	public static final int VK_B = GLFW.GLFW_KEY_B;

	/** Constant for the "C" key. */
	public static final int VK_C = GLFW.GLFW_KEY_C;

	/** Constant for the "D" key. */
	public static final int VK_D = GLFW.GLFW_KEY_D;

	/** Constant for the "E" key. */
	public static final int VK_E = GLFW.GLFW_KEY_E;

	/** Constant for the "F" key. */
	public static final int VK_F = GLFW.GLFW_KEY_F;

	/** Constant for the "G" key. */
	public static final int VK_G = GLFW.GLFW_KEY_G;

	/** Constant for the "H" key. */
	public static final int VK_H = GLFW.GLFW_KEY_H;

	/** Constant for the "I" key. */
	public static final int VK_I = GLFW.GLFW_KEY_I;

	/** Constant for the "J" key. */
	public static final int VK_J = GLFW.GLFW_KEY_J;

	/** Constant for the "K" key. */
	public static final int VK_K = GLFW.GLFW_KEY_K;

	/** Constant for the "L" key. */
	public static final int VK_L = GLFW.GLFW_KEY_L;

	/** Constant for the "M" key. */
	public static final int VK_M = GLFW.GLFW_KEY_M;

	/** Constant for the "N" key. */
	public static final int VK_N = GLFW.GLFW_KEY_N;

	/** Constant for the "O" key. */
	public static final int VK_O = GLFW.GLFW_KEY_O;

	/** Constant for the "P" key. */
	public static final int VK_P = GLFW.GLFW_KEY_P;

	/** Constant for the "Q" key. */
	public static final int VK_Q = GLFW.GLFW_KEY_Q;

	/** Constant for the "R" key. */
	public static final int VK_R = GLFW.GLFW_KEY_R;

	/** Constant for the "S" key. */
	public static final int VK_S = GLFW.GLFW_KEY_S;

	/** Constant for the "T" key. */
	public static final int VK_T = GLFW.GLFW_KEY_T;

	/** Constant for the "U" key. */
	public static final int VK_U = GLFW.GLFW_KEY_U;

	/** Constant for the "V" key. */
	public static final int VK_V = GLFW.GLFW_KEY_V;

	/** Constant for the "W" key. */
	public static final int VK_W = GLFW.GLFW_KEY_W;

	/** Constant for the "X" key. */
	public static final int VK_X = GLFW.GLFW_KEY_X;

	/** Constant for the "Y" key. */
	public static final int VK_Y = GLFW.GLFW_KEY_Y;

	/** Constant for the "Z" key. */
	public static final int VK_Z = GLFW.GLFW_KEY_Z;
	...
	public static final int VK_DELETE = GLFW.GLFW_KEY_DELETE; /* ASCII DEL */
	...
	public KeyEvent(FComponent source, int key, int action, int mods) {
		super(source, mods);
		this.code = key;
		this.action = action;
	}
